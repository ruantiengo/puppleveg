...
import { updateEmployee } from '../../../store/employess/update'
...
const UpdateButton = ({ type, cpf, setEmployees, employee }: Props) => {
  return (
    <Dialog>
      ...
      <DialogContent>
        ...
        <Fieldset>
          ...
          <Input
            ...
            onChange={(e) => {
              employee.profession = e.target.value
            }}
          />
        </Fieldset>
        <Fieldset>
            ...
            <ContentButton
              ...
              onClick={async () => {
                try {
                  ...
                  setEmployees((old) => old.filter((el) => el.cpf !== cpf))

...
import { deleteCostumer } from '../../../store/costumers/delete'
...
const DeleteIcon = ({ type, cpf, setCostumer }: Props) => (
  <AlertDialog>
    ...
    <AlertDialogContent>
      ...
      <AlertDialogDescription>
        Essa ação não pode ser desfeita. Esse ato vai permanentemente excluir
        esses dados do nosso sistema.
      </AlertDialogDescription>
      <Flex css={{ justifyContent: 'flex-end' }}>
        <AlertDialogCancel asChild>
          <ButtonB variant="mauve" css={{ marginRight: 25 }}>
            Cancelar
          </ButtonB>
        </AlertDialogCancel>
